...
Original file is located at
    https://colab.research.google.com/drive/1SxTvgjduEqTNd13TqUZnwMzdr-ZSe2pP
"""
...
CSV_PATH = "/music_instrument_feature.csv"
...
# save the train csv
df_train.to_csv("/content/music_instrument_feature_train.csv", index = False)
# save the test csv
df_test.to_csv("/content/music_instrument_feature_test.csv", index = False)